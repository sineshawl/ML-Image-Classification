...
def classify_image(base_64_data, file_path=None):
    imgs = get_image_with_2_eyes(file_path, base_64_data)
...
def load_saved_artifacts():
    ...
    with open("E:\\RoadMap\\ML Projects\\ML-Image-Classification\\Server\\Artifacts\\Class_dictionary.json", "r") as f:
        __class_name_to_number = json.load(f)
        __class_number_to_name = {v:k for k,v in __class_name_to_number.items()}

    global __model
    if __model is None:
        with open("E:\\RoadMap\\ML Projects\\ML-Image-Classification\\Server\\Artifacts\\my_model.pkl", 'rb') as f:
...
def get_base64_for_teddy():
    with open('E:\\RoadMap\\ML Projects\\ML-Image-Classification\\Server\\base64.txt') as file:
        return file.read()
